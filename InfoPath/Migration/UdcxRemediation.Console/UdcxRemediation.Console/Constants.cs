...
namespace UdcxRemediation.Console
{
    ...
    public class Constants
    {
        ...
        public static readonly string UdcxRepotInputFileName = "UDCXReport.csv";
        public static readonly string UdcxReport = "UDCXStatusReport_" + DateTime.Now.ToString("dd_MM_yyyy_hh_mm_ss") + ".csv";
        public static readonly string SuccessStatus = "Success";
        public static readonly string ErrorStatus = "Error";
        public static readonly string NoAuthNodeFound = "No authentication node found or it may be commented already";
