...
{
    public class RequestDeactivateSandboxSolution : RemoteOperation
    {

        #region CONSTRUCTORS

        public RequestDeactivateSandboxSolution(string TargetUrl, AuthenticationType authType, string User, string Password, string Domain = "") 
        ...
        public override string OperationPageUrl
        {
            get
            {
                ...
                return "/_catalogs/solutions/Forms/Activate.aspx?Op=DEA&ID=" + SolutionId.ToString();
            }
        }
        ...
        public override void AnalyzeRequestResponse(string page)
        {
            ...
            string pattern = @"javascript:__doPostBack\(\&\#39;(.*?diidIODeactivateSolutionItem)\&\#39;";
